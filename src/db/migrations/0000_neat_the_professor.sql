...
CREATE TYPE "public"."payment_provider" AS ENUM('stripe', 'lemon_squeezy', 'gumroad', 'paddle');--> statement-breakpoint
CREATE TYPE "public"."pricing_type" AS ENUM('one-time', 'subscription', 'free');--> statement-breakpoint
